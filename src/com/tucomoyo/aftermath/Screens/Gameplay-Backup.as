package com.tucomoyo.aftermath.Screens 
{
    ...
    public class Gameplay extends Scene 
    {
        ...
        public function onAdded(e:Event):void {
            ...
            //texturesScene.addTexture("screens", "Backgrounds");//32mb
            texturesScene.addTexture("Botones", "Buttons");//4mb
            texturesScene.addTexture("Gui", "Buttons");//16mb
            texturesScene.addTexture("chooperFull", "vehicles");//0.5mb
            texturesScene.addTexture("chopper", "vehicles");//4mb
            texturesScene.addTexture("Buildings", "World");//4mb
            texturesScene.addTexture("worldObjects", "World");//8mb
            texturesScene.addTexture("Animations", "World");//8mb
			texturesScene.addTexture("vehicleShield", "vehicles");//0.5mb
			texturesScene.addTexture("vehicleExplosion", "vehicles");//4mb
			texturesScene.addTexture("crystalSpawn", "Npc");//0.5mb*/
        ...
        public function initGamePlay(e:flash.events.Event):void {
			...
			globalResources.trackEvent("Screen View", "user: " + globalResources.user_id, "Gameplay Screen");
        ...
        public function onAtlasLoad(e:GameEvents):void {
            ...
            //bitmapsScene.addTexture("Debris", "World");
		...
		private function saveMission(_save:Object):void {
			...
			connect.save_state(parseInt(globalResources.user_id), parseInt(missionSource.metadata.id), save);
		}
		...
		private function saveObjectsToTrophyroomComplete(e:GameEvents):void {
			connect.removeEventListener(GameEvents.REQUEST_RECIVED, saveObjectsToTrophyroomComplete);
			if (completeMission) { 
				connect.sendMissionComplete(parseInt(globalResources.user_id), mission_use_id);
...
//			Eliminar del arreglo de objetos y mi mundo el objeto dropeado
		...
		public function comfirmCompleteMission():void
		{
			...
			var dialog:Dialogs = new Dialogs(globalResources, texturesScene, soundsScene, 20, 40);
        ...
        public function onMouse(e:TouchEvent):void{     //function onMouse
            ...
            var rec:Rectangle = new Rectangle(680*globalResources.scaleX, 333*globalResources.scaleY, 80*globalResources.scaleX, 68*globalResources.scaleY);

            mouseX = pos.x * globalResources.invX;
            mouseY = pos.y * globalResources.invY;	
            /*
				...
				case "shootState":
					if (!activeShot) 
					{
						...
						if (targetLock == true && targetPosition != null) {
							bullet.x *= globalResources.scaleX;
							bullet.y *= globalResources.scaleY;
        ...
        public function chopperShotUpdate(e:Event):void {
			...
			chopper.updateTarget(mouseX*globalResources.scaleX, mouseY*globalResources.scaleY);
		...
		public function shootEnemie():void {
			...
			if (targetEnemie.hp < 1) {
				...
				world.add_object_enemie(1, new Point(targetEnemie.x, targetEnemie.y), new Point(posX, posY));
