...
:: Android packaging
set AND_CERT_NAME="AftermathRebornM"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AftermathRebornM.p12
...
set IOS_PROVISION=cert\AftermathRebornM.mobileprovision
...
set APP_ID=air.com.tucomoyo.aftermath.AftermathRebornM

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AftermathRebornM
